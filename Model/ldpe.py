...
from sklearn.linear_model import Lasso,LassoCV,lasso_path,LogisticRegressionCV
from switchfamily import switch_binomial

class Lassoproj:
    def __init__(self, ci=False, ci_level=0.95, standardize=True, robust=True, family="gaussian", verbose=True):
    ...
    def calculate_ci(self,ci_level):
        ######## calculate confidence interval
        uci = self.bhat + norm.ppf(1-ci_level/2)*self.se
        lci = self.bhat - norm.ppf(1-ci_level/2) *self.se
        return lci,uci
